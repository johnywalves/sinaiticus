---
title: "Inglês Técnico para Entrevistas e Cliente"
layout: base.njk
category: Plano de Estudos
tags: [english, soft-skills, carreira, study-plan, interview]
---

Trilha #5 do [[study-plan-gaps|plano de estudos]]. Comunicação técnica fluente em
inglês — o ponto citado sobre "frequent technical discussions in English with the
client".
...
- **Perguntas de clarificação**: "Just to confirm, do you mean…?",
  "What are the constraints around…?".
- **Discordar com educação**: "I see your point, however…",
...
- Shadowing de tech talks (repetir junto para ritmo/pronúncia).

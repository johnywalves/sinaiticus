---
title: "Component Library Versioning (safe adoption across MFEs)"
layout: base.njk
category: Frontend
tags: [component-library, versioning, frontend, interview]
---

Note from the [[nix-interview-prep|N-iX interview prep]] — design system across MFEs.
...
supported themes/variants. See [[testing-react-data-fetching|component tests]].
...
Related: [[microfrontend-communication|micro-frontends]] ·
[[azure-devops-cicd-pipeline|CI/CD]] · [[nix-interview-prep|index]].

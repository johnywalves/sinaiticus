---
title: "Code-Splitting in React (shrink the initial bundle)"
layout: base.njk
category: Frontend
tags: [react, performance, frontend, interview]
---

A practical companion to [[react-performance|React performance]]: deferring
JavaScript is one of the biggest levers on initial load.
...
Related: [[react-performance]] · [[microfrontend-communication|micro-frontends]] ·

---
title: "Express Middleware Chain (auth, rate limit, validation)"
layout: base.njk
category: Backend
tags: [express, nodejs, backend, interview]
---

Note from the [[nix-interview-prep|N-iX interview prep]] — backend HTTP layer.
...
Related: [[nodejs-high-concurrency|Node.js under high concurrency]] ·
